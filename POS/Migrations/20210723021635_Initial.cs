    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductPurchaseSizeColor", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductPurchaseSizeColor_Color_ColorId",
                        column: x => x.ColorId,
                        principalTable: "Color",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductPurchaseSizeColor_ProductPurchase_ProductPurchaseId",
                        column: x => x.ProductPurchaseId,
                        principalTable: "ProductPurchase",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductPurchaseSizeColor_Size_SizeId",
                        column: x => x.SizeId,
                        principalTable: "Size",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductSaleSizeColor", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductSaleSizeColor_Color_ColorId",
                        column: x => x.ColorId,
                        principalTable: "Color",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductSaleSizeColor_ProductSale_ProductSaleId",
                        column: x => x.ProductSaleId,
                        principalTable: "ProductSale",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductSaleSizeColor_Size_SizeId",
                        column: x => x.SizeId,
                        principalTable: "Size",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductPurchaseSizeColor_ColorId",
                table: "ProductPurchaseSizeColor",
                column: "ColorId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductPurchaseSizeColor_ProductPurchaseId",
                table: "ProductPurchaseSizeColor",
                column: "ProductPurchaseId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductPurchaseSizeColor_SizeId",
                table: "ProductPurchaseSizeColor",
                column: "SizeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductSaleSizeColor_ColorId",
                table: "ProductSaleSizeColor",
                column: "ColorId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductSaleSizeColor_ProductSaleId",
                table: "ProductSaleSizeColor",
                column: "ProductSaleId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductSaleSizeColor_SizeId",
                table: "ProductSaleSizeColor",
                column: "SizeId");
